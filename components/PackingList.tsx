...
export default function PackingList() {
              ...
              <div className="flex items-start justify-between gap-2">
                <div className="flex min-w-0 items-start gap-2">
                  <button
                    ...
                    aria-label={
                      item.sudahAda ? "Tandai belum ada" : "Tandai sudah ada"
                    }
  ...
  const fullContent = (
    <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
      {errorBanner}
      {addForm}
      <div className="p-4 pt-0">{itemsList}</div>
    </div>
  );
    ...
    <>
      ...
      {viewMode === "full" && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
          ...
          />
          <div
            className="relative flex max-h-[min(90vh,48rem)] min-h-0 w-full max-w-3xl flex-col overflow-hidden rounded-2xl border border-emerald-100 bg-white shadow-2xl"
